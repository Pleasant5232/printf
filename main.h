...
int prin_lunt(va_list arguments, char *buf, unsigned int ibuf);
int prinloct(va_list arguments, char *buf, unsigned int ibuf);
int prinlhex(va_list arguments, char *buf, unsigned int ibuf);
int prin_lupx(va_list arguments, char *buf, unsigned int ibuf);
...
int prin_hex(va_list arguments, char *buf, unsigned int ibuf);
